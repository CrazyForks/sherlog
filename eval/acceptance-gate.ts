...
import type { FindResult, SessionSourceId, SyncSummary } from "./types";
...
// its transcripts are zstd-compressed JSONL; coverage lives in native Rust
// e2e tests instead of this harness.
